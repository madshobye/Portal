...
import { renderProjectControlClusters } from "./ide-toolbar.js?v=0.1.87-ui725";
import { createDomRefs } from "./dom-refs.js?v=0.1.87-ui725";
import { createAppState } from "./app-state.js?v=0.1.87-ui725";
import { createAppControllerAccessors } from "./app-controller-accessors.js?v=0.1.87-ui725";
import { createAppRegistries } from "./app-registry-factory.js?v=0.1.87-ui725";
import { migrateLegacyBrowserStorage, product } from "./app-config.js?v=0.1.87-ui725";

const WEB_UI_VERSION = "0.1.87-ui725";
