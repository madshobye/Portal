...
import { renderProjectControlClusters } from "./ide-toolbar.js?v=0.1.87-ui728";
import { createDomRefs } from "./dom-refs.js?v=0.1.87-ui728";
import { createAppState } from "./app-state.js?v=0.1.87-ui728";
import { createAppControllerAccessors } from "./app-controller-accessors.js?v=0.1.87-ui728";
import { createAppRegistries } from "./app-registry-factory.js?v=0.1.87-ui728";
import { migrateLegacyBrowserStorage, product } from "./app-config.js?v=0.1.87-ui728";

const WEB_UI_VERSION = "0.1.87-ui728";
