...
import { createProjectDomainFeatureRegistry } from "./project-domain-feature-registry.js?v=0.1.87-ui720";
import { createEditorFeatureRegistry } from "./editor-feature-registry.js?v=0.1.87-ui720";
import { createProjectAppFeatureRegistry } from "./project-app-feature-registry.js?v=0.1.87-ui720";
import { createProjectStateAdapter } from "./project-state-adapter.js?v=0.1.87-ui720";
import { createChatStateAdapter } from "./chat-state-adapter.js?v=0.1.87-ui720";
import { createWorkspaceToolbarRegistry } from "./workspace-toolbar-registry.js?v=0.1.87-ui720";
import { normalizeSpecificationMode } from "./specification-format.js?v=0.1.87-ui720";
import { fnv1aHex } from "./script-chunking.js?v=0.1.87-ui720";
import { normalizeChatMessages } from "./revision-chat-model.js?v=0.1.87-ui720";
import { createProjectAppDependencies } from "./project-app-dependencies.js?v=0.1.87-ui720";
import { createEditorFeatureDependencies } from "./editor-feature-dependencies.js?v=0.1.87-ui720";
import { createProjectDomainDependencies } from "./project-domain-dependencies.js?v=0.1.87-ui720";
import { createProjectMaintenanceAppFeatureRegistry } from "./project-maintenance-app-feature-registry.js?v=0.1.87-ui720";
import { createProjectMaintenanceAppDependencies } from "./project-maintenance-app-dependencies.js?v=0.1.87-ui720";
import {
  ...
  sketchStoreName,
  storage,
} from "./app-config.js?v=0.1.87-ui720";
