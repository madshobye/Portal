export const P1_MSGPACK_VERSION = "0.1.87-ui348";
...
function encodeConfigSet(id, op, data = {}) {
  ...
  writer.bool(Object.prototype.hasOwnProperty.call(data, "projectId"));
  writer.string(data.projectId || "");
  writer.bool(Object.prototype.hasOwnProperty.call(data, "projectName"));
  ...
  writer.bool(Object.prototype.hasOwnProperty.call(data, "allowUnauthenticatedAccess"));
  writer.bool(Boolean(data.allowUnauthenticatedAccess));
  return writer.bytes();
}
