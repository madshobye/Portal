...
static inline uint8_t *libusb_get_iso_packet_buffer_simple(struct libusb_transfer *transfer, uint32_t packet_id)
{
...
static inline void libusb_set_iso_packet_lengths(struct libusb_transfer *transfer, size_t length)
{
