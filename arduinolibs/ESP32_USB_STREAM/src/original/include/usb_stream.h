...
#define FLAG_UVC_FORCE_STREAM_CONFIG       (1 << 3)              /*!< force UVC format/frame/interface settings from uvc_config_t */
#define FLAG_UVC_PACKET_STATS              (1 << 4)              /*!< print compact UVC packet stats once per second */
