...
**The application now carries 49 pinned, original fragment-only ISF files (14
generators, 22 effects, and 13 transitions). The collection includes
...
that resource becomes ready. A repeatable repository inventory reports
capabilities before selection. Custom vertex and extra non-transition
image-input contracts remain part of this open item.**
