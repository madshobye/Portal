...
test("parameter view owns reusable inspector controls outside the controller", () => {
  ...
  assert.match(componentView, /from "\.\/parameter-view\.js\?v=chain-general-controls-1"/);
  assert.match(sceneLiveView, /from "\.\/parameter-view\.js\?v=chain-general-controls-1"/);
