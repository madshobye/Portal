...
export function featureMorphNodeProcess(inputs = {}, context = {}) {
  if (typeof context.renderNativeVisualNode !== "function") throw new Error("FEATURE_MORPH_NODE_RENDER_HOST_MISSING");
  return context.renderNativeVisualNode({ inputs, context });
}

export function featureMorphNodeModuleParts({
  process = featureMorphNodeProcess,
  moduleUrl = import.meta.url,
  analysisPart = {
    id: "feature-morph-analysis-module",
    name: "Feature Morph matching and field algorithm",
  ...
  return [
    ...
    {
      id: "feature-morph-process",
      name: "Feature Morph process entry",
      kind: NODE_PART_KINDS.JAVASCRIPT,
      language: "javascript",
      editable: true,
      module: moduleUrl,
      export: process.name,
      entry: "process",
      dependsOn: [...(analysisPart ? [analysisPart.id] : []), "feature-morph-fit-module"],
...
export const FeatureMorphNodeModuleExports = Object.freeze({
  imageFitUniform,
  matchSuperPointFeatures,
  buildFeatureMorphField,
  buildFeatureMorphMesh,
