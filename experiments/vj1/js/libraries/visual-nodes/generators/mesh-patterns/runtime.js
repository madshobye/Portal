...
// Keep every private geometry helper in the same editable node part. The host
// receives this compiled module once and retains only WebGL/cache resources.
export function meshPatternAlgorithmModuleSource() {
  return [
    `const TAU = Math.PI * 2;`,
    `const EPSILON = 1e-7;`,
    `const MESH_PATTERN_FAMILIES = Object.freeze(${JSON.stringify(MESH_PATTERN_FAMILIES)});`,
