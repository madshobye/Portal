...
// The editable module contains the real procedural geometry implementation.
// The retained host supplies the p5/WebGL target and presentation lifecycle.
export function anatomyAlgorithmModuleSource() {
  return [
    `const ANATOMY_RING_CACHE = new Map();`,
    clamp01,
    drawWithPolygonOffset,
    anatomyPartFitScale,
    ...
    anatomyTriangle,
    drawAnatomyMesh,
    anatomyProfileVolume,
    anatomyTaperedSegment,
    anatomyMixPoint,
    anatomyPathVolume,
    anatomyShade,
    anatomyAdvanceDown,
...
export const AnatomyNodeModuleExports = Object.freeze({
  anatomyPartFitScale,
  drawProceduralAnatomy,
});
