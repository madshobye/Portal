...
export function terrainBiomeMaterialProviderProcess(inputs = {}, { state = {}, output = null } = {}) {
  ...
  const values = {
    ...
    downSlopeColor: setting(settings, inputs, "downSlopeColor"),
    directionColor: setting(settings, inputs, "directionColor"),
    skyColor: setting(settings, inputs, "skyColor"),
    textureGrain: finite(setting(settings, inputs, "textureGrain"), 0),
    textureDepth: finite(setting(settings, inputs, "textureDepth"), 0),
    colorDirection: finite(setting(settings, inputs, "colorDirection"), 0),
