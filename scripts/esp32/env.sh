...
case "${ESP32_FQBN}" in
  ...
  esp32:esp32:esp32)
    ...
    ;;
  *)
    echo "Unsupported ESP32_FQBN for Arduino_ESP32_WebRTC archive selection: ${ESP32_FQBN}" >&2
    exit 2
    ;;
esac
...
ESP32_WEBRTC_ARCH_LIBS="${ESP32_WEBRTC_ARCH_LIBS:-${PORTAL_ROOT}/arduinolibs/Arduino_ESP32_WebRTC/src/${ESP32_WEBRTC_ARCH_DIR}}"
